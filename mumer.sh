...
wkd=/share/home/chuanlex/yaoxinw/project/canu_1.8_nanopolish/result/
cd $wkd
mkdir -p $wkd/plot ;
tool=canu_1.8
...
draft_dir=/share/home/chuanlex/yaoxinw/project/canu_1.8_nanopolish/${species}
cd ${draft_dir} ;
...
grep 'TotalSNPs' out.report | awk '{print $2}'  >> $wkd/${tool}.all_stat ;
done
